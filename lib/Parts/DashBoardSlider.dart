...
class DashBaordSlider extends StatefulWidget {

  @override
  State<DashBaordSlider> createState() => _DashBaordSliderState();
}

class _DashBaordSliderState extends State<DashBaordSlider> {
